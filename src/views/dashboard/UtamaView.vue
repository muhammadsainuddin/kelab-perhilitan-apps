  ...
  <div class="space-y-4 pb-6 animate-page-in">
    ...
    <div class="reveal space-y-3" style="--d: 220ms;">
      ...
      <div class="flex gap-2.5 overflow-x-auto no-scrollbar pb-1">
        ...
        <button @click="$router.push('/dashboard/ajk')"
          class="shrink-0 flex flex-col items-center gap-2 p-4 rounded-[18px] w-22 transition-all active:scale-[0.94]"
          style="background: #ECFDF5; border: 1px solid rgba(52,183,136,0.25);">
          <div class="w-10 h-10 rounded-2xl flex items-center justify-center" style="background: rgba(52,183,136,0.12);">
            <svg class="w-5 h-5" fill="none" stroke="#065F46" stroke-width="2" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
            </svg>
          </div>
          <span class="text-[8.5px] font-black uppercase text-center leading-tight" style="color: #065F46;">Hubungi<br>AJK</span>
        </button>
